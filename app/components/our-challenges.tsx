...
export default function OurChallengesPage() {
  ...
  return (
    <div className="container-wrapper grid grid-cols-1 md:grid-cols-2 rounded-3xl">
      <div className={`text-white p-6 sm:p-8 ${!selectedSolution ? 'col-span-2' : ''}`}>
  ...
  >
    View Solution
      ...
      {selectedSolution && (
        <div
  className="text-white p-6 sm:p-8 flex flex-col items-center w-full max-w-full rounded-3xl"
  style={{
