...
export default function OurChallengesPage() {
  ...
  const challenges: Challenge[] = [
    ...
    },
    {
      ...
      solution: "BYOW designed an interactive portfolio with immersive project galleries and detailed case studies. Paired with an intuitive inquiry form, they saw a 50% increase in client leads."
    }
  ];
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-full h-full" style={{ padding: " 50px" }}>
          <>
          ...
          <div key={challenge.id} className="mb-8 sm:mb-12">
            ...
            <div className="flex justify-start">
              ...
              <div className="ml-2 hidden sm:block">
                <Image src="/images/Arrow 1.png" alt="arrow" width={856} height={25} />
              </div>
            </div>
          </div>
        ))}
