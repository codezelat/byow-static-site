      ...
      <div className="container-wrapper px-4 md:px-8 lg:px-12 max-w-7xl mx-auto mt-28">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 text-start">
            ...
            <div className="space-y-4 mb-8">
              <p>
                At BYOW, we believe your website is more than just a digital presence—it's the heart of your brand's story. Our Custom Website Design service is tailored to create unique, visually stunning, and highly functional websites that reflect your identity, values, and goals. Whether you're a startup, a growing business, or an established brand, we work closely with you to design a website that not only looks amazing but also delivers results.
              </p>
              <p>
        ...
        <div className="mt-8 mb-12 text-start">
          <p className="mb-4">
            But our work doesn't stop at launch. We believe that a great website is a living, evolving entity that grows with your business. That's why we offer ongoing support, updates, and maintenance to keep your site fresh, secure, and ahead of the curve. Whether you need a small change or a complete overhaul, we're here to help you every step of the way.
          </p>
          <p className="mb-4">
            At BYOW, we're more than just a web design and development company—we're your partners in growth. We're passionate about helping you succeed in the digital world, and we're committed to delivering solutions that not only meet but exceed your expectations. Whether you're just starting out or looking to take your online presence to the next level, we're here to help you create something that truly represents who you are.
          </p>
          <p>
