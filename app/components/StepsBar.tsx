...
const StepsBar: NextPage = () => {
  ...
  return (
    <div className="h-auto pb-12 md:pb-24 sm:pb-5 px-4 md:px-6">
      <div className="flex flex-col md:pt-40 sm:pb-10 px-10 pb-10 pt-44 gap-[24px]">
      ...
      <div className="w-full relative md:px-10 md:pt-10">
        {/* Mobile view - steps in sequential order (1-2-3-4) */}
        <div className="lg:hidden flex flex-col gap-16 w-full">
          {/* Step 1 card */}
          <div
            ref={stepRefs[0]}
            className="w-full p-6 relative bg-black rounded-[20px]"
            style={{
              position: "relative",
              borderRadius: "20px",
              background: "black",
          ...
          >
            ...
            <p className="text-sm font-normal leading-[140%] text-left pb-4 text-white">
        ...
        {/* Desktop view - original zigzag layout */}
        <div className="hidden lg:flex flex-row gap-20 justify-center mx-auto px-6">
          {/* Left Column */}
          <div className="flex flex-col gap-36 w-full">
            {/* Step 1 card */}
            <div
              ref={stepRefs[0]}
              className="w-[350px] xl:w-[500px] p-8 relative bg-black rounded-[20px] ml-40 xl:ml-0"
              style={{
                position: "relative",
                borderRadius: "20px",
                background: "black",
          ...
          {/* Desktop Stepper Line - only visible on larger screens */}
          ...
          <div className="flex flex-col gap-36 mt-36">
            ...
            <div
              ref={stepRefs[1]}
              className="w-[350px] xl:w-[500px] p-8 relative bg-black rounded-[20px] mr-40 xl:mr-0"
              style={{
                position: "relative",
                borderRadius: "20px",
                background: "black",
