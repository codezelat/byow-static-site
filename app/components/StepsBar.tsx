          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col ml-16">
              <div className="absolute left-5 w-[42px] h-[42px] rounded-full border-2 border-[#9654F4] bg-black transform -translate-x-1/2">
                <div className={`w-[25px] h-[25px] rounded-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ${
      ...
      <div className="hidden md:block w-full relative">
        <div className="w-full flex flex-col lg:flex-row gap-6 pt-10 lg:pt-20 justify-center">
          ...
          <div className="flex flex-col gap-16 lg:gap-36 w-full lg:w-auto">
            <div
              ref={stepRefs[0]}
              className="w-full lg:w-[500px] p-6 lg:p-8 relative"
              style={{
                border: "1px solid",
                borderImageSource: "linear-gradient(180deg, #8133F1 0%, #090909 100%)",
                borderImageSlice: 1,
