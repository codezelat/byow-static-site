...
const Home: NextPage = () => {
  ...
  return (
    <div className="text-center">
      ...
      {/* Cards Container */}
     <div className="flex justify-center items-center gap-4 sm:gap-6 md:gap-8 w-full mt-28 sm:mt-20 md:mt-24">
      
        {cardData.map((text, index) => (
          <div
            key={index}
            className="w-full max-w-[300px] sm:max-w-[45%] md:max-w-[314.75px] min-h-[150px] sm:min-h-[200px] md:h-[215px] rounded-xl sm:rounded-2xl md:rounded-[32px] border p-4 sm:p-6 md:p-10 flex flex-col items-center justify-center text-center text-white backdrop-blur-[4px] relative"
